...
//
// This is safe for QPACK decoding because:
//  - Decoded strings are immediately copied to Header structs
//  - Source buffer (stringBuf) is reused but not modified during string lifetime
//  - Strings are returned as part of Header which copies them
//
